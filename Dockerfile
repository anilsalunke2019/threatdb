...
RUN apt-get update && apt-get install -y --no-install-recommends apt-utils && \
 apt-get -y install supervisor subversion wget curl git zip unzip apache2 nano python3.6 python3-pip php7.2 php7.2-curl  php7.2-gd php7.2-json php7.2-mbstring php7.2-mysqli && \
