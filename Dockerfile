...
RUN apt-get update && \
  apt-get -y install supervisor wget curl git apache2 libapache2-mod-php7 mysql-server php7-mysql  php7-json php7-curl php7-gd pwgen php-apc php7-mcrypt zip unzip  && \
