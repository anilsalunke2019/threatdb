...
RUN apt-get update && \
  apt-get -y install supervisor wget curl git apache2 libapache2-mod-php mysql-server php-mysql  php-json php-curl php-gd pwgen php-apc php-mcrypt zip unzip  && \
